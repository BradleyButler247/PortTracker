    ...
    return (
        currUser.username !== '' ? (
            <div className='home-container mx-auto '>
                ...
                <Row className='user-info-edit-form'
                ...
                <div className='user-info-container row mx-auto mt-5 col-11' style={{ display: infoDisplay }}>
                    ...
                    <ProfileInfo currUser={ currUser } toggleForm={ toggleForm } userTradeTotal={ userTradeTotal } />

                    {/* <Card className='mt-2 mx-auto col-9' style={{ color: '#FBF8E6' }}>
