            ...
            <Table striped hover dark className='col-12 mx-auto'>
                <thead>
                    <tr>
                        ...
                        <th className='table-header text-start col-1 pe-3' onClick={()=> sortCats('market_cap')}>
                            <div className='d-inline'>Market Cap (USD)</div> 
                            <div className='d-inline px-2'>
                                <FilterIcon type='market_cap' currentFilter={sortBy} direction={sortDirection} />
                            </div>
                        </th>
                        <th className='table-header text-start' onClick={()=> sortCats('market_cap_change')}>
                            <div className='d-inline col-12' style={{ whiteSpace: 'nowrap' }}>∆ (24hr)</div> 
                            <div className='d-inline px-2'>
